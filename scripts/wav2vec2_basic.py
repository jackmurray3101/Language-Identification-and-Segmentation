from transformers import Wav2Vec2ForSequenceClassification, Wav2Vec2FeatureExtractor, Wav2Vec2Model, Data2VecAudioForSequenceClassification, HubertForSequenceClassification
...
for param in model.hubert.encoder.layers[10].parameters():
