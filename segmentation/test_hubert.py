...
model.load_state_dict(torch.load("./saved_trained_models/hubert/Hubert-3-different-epoch50.pt"))
model.eval()

cwd = os.getcwd()
signal_path = os.path.join(cwd, "data")
signal_path = os.path.join(signal_path, "10min-english.wav")
...
signal_path = os.path.join(cwd, "data")
signal_path = os.path.join(signal_path, "10min-spanish.wav")
signal = librosa.load(signal_path, sr=16000, mono=True)[0]
...
signal_path = os.path.join(cwd, "data")
signal_path = os.path.join(signal_path, "9.5min-korean.wav")
signal = librosa.load(signal_path, sr=16000, mono=True)[0]
